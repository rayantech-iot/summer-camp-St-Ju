        ...
        <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="mt-6 text-lg sm:text-xl text-gsc-white/70 max-w-2xl mx-auto">
              Choisis ton camp et inscris-toi dès maintenant&nbsp;!
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
              <div className="bg-gsc-gray/20 p-8 border border-gsc-gray/30 flex flex-col">
                <h3 className="font-heading text-2xl text-gsc-white tracking-wider">Camp Basket</h3>
                <p className="text-sm text-gsc-white/60 mt-3">4-11 juillet / 11-18 juillet</p>
                <p className="text-sm text-gsc-white/60">Valleiry</p>
                <div className="my-6 space-y-2">
                  <p className="text-gsc-white font-bold text-lg">Externat — {basketOffer?.price_externat || 300}€</p>
                  <p className="text-gsc-white font-bold text-lg">Internat — {basketOffer?.price_internat || 490}€</p>
                </div>
              </div>
              <div className="bg-gsc-gray/20 p-8 border border-gsc-gray/30 flex flex-col">
                <h3 className="font-heading text-2xl text-gsc-white tracking-wider">Multisport</h3>
                <p className="text-sm text-gsc-white/60 mt-3">6-13 juillet / 13-17 juillet</p>
                <p className="text-sm text-gsc-white/60">Vulbens</p>
                <div className="my-6">
                  <p className="text-gsc-white font-bold text-lg">Externat — {multiOffer?.price_externat || 300}€</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              >
                S&apos;inscrire maintenant <ExternalLink size={20} />
              </a>
              <p className="text-sm text-gsc-white/40 mt-4">Paiement sécurisé par Hello Asso</p>
            </div>
          </div>
        </AnimatedSection>
      </main>
