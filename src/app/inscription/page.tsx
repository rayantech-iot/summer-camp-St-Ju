          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
              <div className="bg-gsc-gray/20 p-8 border border-gsc-gray/30 flex flex-col">
                ...
                <p className="text-sm text-gsc-white/60 mt-3">{t('inscription.basket.dates')}</p>
                <p className="text-sm text-gsc-white/60">{t('inscription.basket.location')}</p>
                <div className="my-6 space-y-2">
                  <p className="text-gsc-white font-bold text-lg">{t('inscription.externat')} {basketOffer?.price_externat || 300}€</p>
                  <p className="text-gsc-white font-bold text-lg">{t('inscription.internat')} {basketOffer?.price_internat || 490}€</p>
                </div>
              </div>
              <div className="bg-gsc-gray/20 p-8 border border-gsc-gray/30 flex flex-col">
                <h3 className="font-heading text-2xl text-gsc-white tracking-wider">{t('inscription.multi.title')}</h3>
                <p className="text-sm text-gsc-white/60 mt-3">{t('inscription.multi.dates')}</p>
                <p className="text-sm text-gsc-white/60">{t('inscription.multi.location')}</p>
                <div className="my-6">
                  <p className="text-gsc-white font-bold text-lg">{t('inscription.externat')} {multiOffer?.price_externat || 300}€</p>
                </div>
              </div>
            </div>
